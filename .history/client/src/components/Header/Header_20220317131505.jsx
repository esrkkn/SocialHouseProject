        ...
        <MDBContainer fluid>
          ...
          <div className="collapse navbar-collapse" id="navbarExample01">
            <MDBNavbarNav right className="mb-2 mb-lg-0">
              ...
              <MDBNavbarItem>
                <MDBNavbarLink >
                  <NavLink to="/post" style={{textDecorationLine: "none", color:"grey"}}>Create Post</NavLink>
                </MDBNavbarLink>
              </MDBNavbarItem>
              <MDBNavbarItem>
                <MDBNavbarLink >
                  <NavLink to="/register" style={{textDecorationLine: "none", color:"grey"}}>Register</NavLink>
                </MDBNavbarLink>
              </MDBNavbarItem>
              <MDBNavbarItem>
                <MDBNavbarLink >
                  <NavLink to="/login" style={{textDecorationLine: "none", color:"grey"}}> Login</NavLink>
                </MDBNavbarLink>
              </MDBNavbarItem>
            </MDBNavbarNav>
          </div>
