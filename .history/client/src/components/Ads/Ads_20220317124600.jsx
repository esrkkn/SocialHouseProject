          ...
          <MDBRow className="g-0">
            ...
            <MDBCol md="8">
              <MDBCardBody>
                ...
                <MDBCardText style={{ fontSize: "20px", padding: "20px", fontWeight: "bold"}}>{item.location}</MDBCardText>
                <MDBCardText style={{ fontSize: "40px", paddingLeft: "20px", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                  <span>{item.rooms}rm</span>
                  <span style={{ fontSize: "40px", padding: "20px", fontWeight: "bold" }}>{item.price}€</span>
                </MDBCardText>
              </MDBCardBody>
            </MDBCol>
          </MDBRow>
